/**
 * AVC 100 End-of-Course Survey · Google Form builder
 *
 ...
 *  4. Click Save
 *  5. Make sure the dropdown at the top says: buildAVC100Survey
...
function buildAVC100Survey() {

  var form = FormApp.create('AVC 100 · End-of-Course Survey');
  ...
  form.addPageBreakItem()
      ...
      .setHelpText('Some of these ask you to think back to your first week. Best honest guess is fine. This is not a test of how good you are, it is about how the class felt.');

  form.addGridItem()
      .setTitle('Think back to your FIRST WEEK. How much do you agree? (1 = strongly disagree, 5 = strongly agree)')
      .setRows([
        'In my first week, opening Illustrator, Photoshop, and After Effects felt intimidating.',
        'In my first week, I knew where to go for help at GCC.'
      ])
