...
>
> 🎓 **Finish the near-complete credentials, priority order: League, Google, Anthropic, UM.** League for Innovation AI Fellows (in progress, capstone through Oct 2026); Google GAIL (take the certification exam; study guide at `cultivate/GAIL_Study_Cliff_Notes.md`); Teaching AI Fluency, Anthropic Academy (almost done, finish next week); U-Michigan "Gen AI as a Learning Design Partner" Coursera (almost done, finish next week). Then the extra Coursera courses already signed up for, if time. (Done: QM earned, EDUCAUSE earned, Purdue course completed; Scrum removed from CV, not started.)
>
