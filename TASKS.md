...
| **STEAMworks grant money** | `~/Documents/Claude/SteamworksGrant/NOTES.md` | **Nothing drafted.** Deadline moved to Monday and needs confirming. Three questions to ask her before writing. |
...
**The two things most likely to slip:** nobody has read the merged application PDF end to end on screen, open since 4 September, and the STEAMworks request has a deadline inside the next few days with nothing on paper.
...
- [ ] **STEAMworks training grant proposal.** Deadline moved from Fri 11 Sept to **Mon 14 Sept, confirm this.** Submitted by email or hand delivery. $36.44/hr, 30 to 90 hours typical. Two forms planned: fabrication (vinyl, laser, 3D across AVC183, AVC248 and The Traveler, 68 hours at $2,477.92) and drones, still unsure whether drones must attach to a class. **Nothing drafted yet. Working notes and the three questions to ask her are at `~/Documents/Claude/SteamworksGrant/NOTES.md`.**
