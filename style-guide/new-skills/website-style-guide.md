...
- **Footer**: left-aligned, one fixed row: Home · Work · About · Email · Top ↑ (middot separators), then "© 2026 Michelle Blomberg. All rights reserved." DM Sans, 0.85rem, `--muted`. **Nothing else in the footer.**
