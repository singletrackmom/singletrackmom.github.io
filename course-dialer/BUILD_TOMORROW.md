...
3. Whichever loses, move it to `course-dialer/_archive/` so no reviewer stumbles into it. (The old `_to_delete/` folder is gone: its two pending skill drafts were already live as saved Cowork skills, so they were removed on 28 Aug 2026.)
