...
- **P2 Student Journey UX Study** — 3 personas live the full journey at all 10 colleges; **problems, not destinations** (we never say "go to advising"; the persona figures it out); capture barriers + severity. Includes **swirling** (2 personas enroll at a 2nd college: 2nd application, residency re-proof, consortium aid, credit-back) and a **graduation offboarding** task (save email/Drive/coursework before the account closes).
